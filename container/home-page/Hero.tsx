        ...
        <div className="w-full flex flex-col justify-between h-[75vh] sm:h-[85vh] xm:h-[85vh]">
              ...
              <div className="mt-[80px] ml-[100px] sm:ml-[20px] xm:ml-[20px] sm:mt-[40px] xm:mt-[40px]">
                <div className="btn-container">
                  ...
                  <a
                    ...
                    className="btn"
                  >
                    <span className="btn-text">Book an Apointment</span>
                  </a>
          ...
          <div className="w-full flex flex-col h-[22vh] border-t border-[#4B2E2B55] bg-[#3A1B0D] p-[20px] sm:mb-[80px] xm:mb-[80px] gap-[25px]">
            <div className="flex justify-between items-center padding-x gap-[20px] sm:flex-col sm:items-start xm:flex-col xm:items-start">
              <div className="w-[50%] sm:w-full">
                ...
                <p className="paragraph font-NeueMontreal text-[#FFEDE0]">
                  From high-performance ad campaigns to conversion-optimized
                  funnels that drive measurable ROI.
                </p>
              </div>
            ...
            <div className="flex items-center justify-end padding-x">
              <span className="text-[14px] tracking-[0.4em] text-[#FFEDE0] uppercase">
                Live now
              </span>
            </div>
          </div>
