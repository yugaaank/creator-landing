...
export default function Works() {
	return (
		<section className="w-full bg-[#481E14] rounded-t-[20px]">
			<div className="w-full bg-[#481E14] z-10 relative rounded-t-[20px] pt-[100px] lg:pt-[80px] md:pt-[60px] sm:pt-[40px] xm:pt-[40px]">
				<Marquee
				...
				{workizItem.map((item) => (
					<div
						...
						<div className="flex items-center gap-[10px] mt-[20px] flex-wrap">
							{item.links.map((link) => (
								<Tags
									className="text-white hover:text-[#0C0C0C]"
									bgcolor="#fff"
									item={link}
									key={link.id}
								/>
			...
			<div className="w-full flex padding-y justify-center">
				<div className="flex items-center justify-between bg-white cursor-pointer rounded-full group">
					<Link
						className="paragraph text-[#0C0C0C] uppercase font-normal font-NeueMontreal"
						href={"/presentation"}>
						<Rounded
							className="py-[6px]"
							backgroundColor="#0C0C0C">
							<p className="text-[#0C0C0C] z-10 px-[10px] ml-[15px] py-[6px] group-hover:text-white">
								view all case studies
							</p>
							<div className="bg-[#0C0C0C] p-[10px] rounded-full scale-[0.3] mr-[10px] group-hover:scale-[0.9] transition-all z-10 text-[#0C0C0C] group-hover:bg-white  duration-300 ease-in-out">
								<ArrowUpRight
									strokeWidth={1.5}
									size={30}
